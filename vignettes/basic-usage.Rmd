...
```{r, echo=FALSE, message=FALSE}
data <- ods_get(search = "Recycling Point Locations", ask = FALSE)
```
...
```{r, echo=FALSE, message=FALSE}
cycle_count <- ods_get(search = "lasgow City Council - Daily cycling counts from automatic cycling counters", ask = FALSE, refresh = TRUE)
```
