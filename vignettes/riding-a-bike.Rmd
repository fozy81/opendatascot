...
![Animation](images/output.gif){width=50%}
...
This section requires ffmpeg system library ti be installed give fine control to generating gif and mpegs videos. 
...
The resulting animations shows the shortest routes cyclists may have used to travel A to B using the cycle network. Of course, people hiring bikes may have chosen a different route but it gives some idea how the transport network in Glasgow looks those hiring bikes. 

![Routes Animation](images/routes.gif){width=50%}
