...
![Animation](images/output.gif){width=350px}
...
NOTE: This requires using [Open Source Routing Machine](http://project-osrm.org/) (OSRM) library to be installed locally. Please follow link and install. Additionally, the OpenStreetMap data for Scotland needs to be downloaded and installed add to OSRM.
...
This section requires [ffmpeg](https://ffmpeg.org/) system library to be installed give fine control to generating gif and mpegs videos. 
...
![Routes Animation](images/routes.gif){width=350px}
